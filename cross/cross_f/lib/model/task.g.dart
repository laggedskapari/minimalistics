...
const TaskSchema = CollectionSchema(
  ...
  properties: {
    r'completedTimeStamp': PropertySchema(
      id: 0,
      name: r'completedTimeStamp',
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  QueryBuilder<Task, Task, QAfterFilterCondition> completedTimeStampIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'completedTimeStamp',
      ));
    });
  }

  QueryBuilder<Task, Task, QAfterFilterCondition>
      completedTimeStampIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> completedTimeStampEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> completedTimeStampGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> completedTimeStampLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> completedTimeStampBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskQuerySortBy on QueryBuilder<Task, Task, QSortBy> {
  QueryBuilder<Task, Task, QAfterSortBy> sortByCompletedTimeStamp() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'completedTimeStamp', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByCompletedTimeStampDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'completedTimeStamp', Sort.desc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByCreatedTimeStamp() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdTimeStamp', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByCreatedTimeStampDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQuerySortThenBy on QueryBuilder<Task, Task, QSortThenBy> {
  QueryBuilder<Task, Task, QAfterSortBy> thenByCompletedTimeStamp() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'completedTimeStamp', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByCompletedTimeStampDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'completedTimeStamp', Sort.desc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByCreatedTimeStamp() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdTimeStamp', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByCreatedTimeStampDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdTimeStamp', Sort.desc);
    });
  }
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
  QueryBuilder<Task, Task, QDistinct> distinctByCompletedTimeStamp() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'completedTimeStamp');
    });
  }

  QueryBuilder<Task, Task, QDistinct> distinctByCreatedTimeStamp() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, DateTime?, QQueryOperations> completedTimeStampProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'completedTimeStamp');
    });
  }
